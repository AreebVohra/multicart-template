            ...
            <div className="landing-page-multikart">
                        ...
                        <div className="row">
                            <div className="col p-0">
                                <div className="top-header">
                                    ...
                                    <div>
                                        <form target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" className="form-inline my-lg-0"
                        ...
                        <Tabs className="theme-tab">
                                ...
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/fashion`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pets`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/watch`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/kids`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/vegetables`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/beauty`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/electronic`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/furniture`} target="_blank" rel="noopener noreferrer">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/col-left/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/column/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/accordian/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/left-image/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/no-sidebar/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/right-image/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/right-sidebar/product/1`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/vertical/product/1`} target="_blank" rel="noopener noreferrer">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/metro/collection`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/full-width/collection`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/no-sidebar/collection`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/right-sidebar/collection`} target="_blank" rel="noopener noreferrer">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/wishlist`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/cart`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/dashboard`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/login`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/register`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/contact`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/forgot-password`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/checkout`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/about-us`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/search`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/compare`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/collection`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/lookbook`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/404`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/pages/faq`} target="_blank" rel="noopener noreferrer">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/details`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/blog-page`} target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/right-sidebar`} target="_blank" rel="noopener noreferrer">
                ...
                <section id="admin" className="section-b-space pt-0">
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                <a href="https://react.pixelstrap.com/multikart-admin/dashboard" target="_blank" rel="noopener noreferrer">
                                    <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/admin/1.jpg`} className="img-fluid lazyload" />
                                </a>
                                <h3>dashboard</h3>
                            </div>
                            <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                <a href="https://react.pixelstrap.com/multikart-admin/products/physical/product-list" target="_blank" rel="noopener noreferrer">
                                    <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/admin/2.jpg`} className="img-fluid lazyload" />
                                </a>
                                <h3>product list</h3>
                            </div>
                            <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                <a href="https://react.pixelstrap.com/multikart-admin/reports/report" target="_blank" rel="noopener noreferrer">
                                    <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/admin/3.jpg`} className="img-fluid lazyload" />
                                </a>
                                <h3>report page</h3>
                            </div>
                            <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                <a href="https://react.pixelstrap.com/multikart-admin/media" target="_blank" rel="noopener noreferrer">
